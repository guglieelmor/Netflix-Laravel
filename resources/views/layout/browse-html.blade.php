...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/assets/js/main-script.js') }}">
            ...
            <section id="browse-dashboard" class=" d-flex direction-column flex-start middle-align">
                <div>
                    <video class="hero-background-image" id="hero-video"
                           poster="/assets/img/tv-show/poster/never-have-ever-tv-show.webp">
                        <source src="/assets/img/tv-show/videos/Never Have I Ever - Official Trailer - Netflix_2.mp4"
                                type="video/mp4">
                ...
                <div class="container text-container" style="z-index: 5;">
                    <div class="contentlogo">
                        <img src="/assets/img/tv-show/poster/never-have-ever-logo.webp" alt="content logo"
                             class="show-logo" />
                    </div>
                    ...
                    <div class="buttons-container m-t-20">
                        <button class="play-button">
                            ...
                            <a href="single.html">Play</a>
                        </button>

                        <button class="more-info-button m-t-20">
                                <span>
                                    <svg viewBox="0 0 24 24">
                                        <path
        ...
        <div class="black-background">
                ...
                <div class="mylist-container d-flex flex-start flex-middle flex-no-wrap owl-carousel">
                    <div class="video">
                        <video class="mylist-img p-r-10 p-t-10 video-item"
                               poster="/assets/img/tv-show/poster/never-have-ever-short poster.jpg">
                            <source
                                src="/assets/img/tv-show/videos/Never Have I Ever - Official Trailer - Netflix_2.mp4"
                                type="video/mp4">
                            Your browser does not support the video tag.
                        </video>
                    ...
                    <div class="video">
                        <video class="mylist-img p-r-10 p-t-10 video-item"
                               poster="/assets/img/movies/we-are-the-milers-poster-little.webp">
                            <source
                                src="/assets/img/movies/videos/We're the Millers - Official Trailer [HD].mp4"
                                type="video/mp4">
                            Your browser does not support the video tag.
                        </video>
                    ...
                    <div class="video">
                        <video class="mylist-img p-r-10 p-t-10 video-item"
                               poster="/assets/img/movies/extraction-poster.jpg">
                            <source
                                src="/assets/img/movies/videos/Murder Mystery - Trailer - Netflix.mp4"
                                type="video/mp4">
                            Your browser does not support the video tag.
                        </video>
            ...
            <section id="continue-watching" class="container p-t-40">
                ...
                <div class="continue-watching-container d-flex flex-start flex-middle flex-no-wrap owl-carousel">
                    ...
                    <div class="video">
                        <video class="mylist-img p-r-10 p-t-10 video-item"
                               poster="/assets/img/movies/horrible-bosses-middle-poster.webp">
                            <source
                                src="/assets/img/tv-show/videos/Never Have I Ever - Official Trailer - Netflix_2.mp4"
                                type="video/mp4">
                            Your browser does not support the video tag.
                    ...
                    <div class="video">
                        <video class="mylist-img p-r-10 p-t-10 video-item"
                               poster="/assets/img/movies/kabir-singh-poster.webp">
                            <source
                                src="/assets/img/tv-show/videos/Never Have I Ever - Official Trailer - Netflix_2.mp4"
                                type="video/mp4">
                            Your browser does not support the video tag.
            ...
            <section id="romantic" class="container p-t-40">
                ...
                <div class="romantic-container d-flex flex-start flex-middle flex-no-wrap owl-carousel">
                    <a href="#">
                        <img src="/assets/img/movies/horrible-bosses-middle-poster.webp" alt=""
                             class="mylist-img p-r-10 p-t-10 image-size item"></a>
                    <a href="#">
                        <img src="/assets/img/movies/kabir-singh-poster.webp" alt=""
                             class="mylist-img p-r-10 p-t-10 image-size item"></a>
                    <a href="#">
                        <img src="/assets/img/movies/extraction-poster.jpg" alt=""
                             class="mylist-img p-r-10 p-t-10 image-size item"></a>
                    <a href="#">
                        <img src="/assets/img/tv-show/poster/never-have-ever-short poster.jpg" alt=""
                             class="mylist-img p-r-10 p-t-10 image-size item"></a>
                    <a href="#">
                        <img src="/assets/img/movies/we-are-the-milers-poster-little.webp" alt=""
                             class="mylist-img p-r-10 p-t-10 image-size item"></a>
            ...
            <section class="big-section d-flex flex-start container">
                <img src="/assets/img/tv-show/poster/sex-education.webp" alt="">

                <div class="right-side">
                    <div class="contentlogo">
                        <img src="/assets/img/tv-show/poster/sex-education-logo.webp" alt="content logo"
                             class="show-logo" />
                    </div>

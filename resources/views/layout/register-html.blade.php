...
<body>
    <main>
        <header class="d-flex space-between middle-align" style="padding: 18px 35px; border-bottom: 1px solid #e6e6e6;">
            <a href="{{ route('home') }}">
            ...
            <a style="float: right;color: #333;font-weight: 700; font-size: 19px;line-height: 90px;" href="{{ route('login') }}"> Entrar </a>
        </header>

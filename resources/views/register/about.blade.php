                ...
                <form action="{{ route('register') }}" method="POST" enctype="multipart/form-data" class="loginContainer c-flex direction-row white" style="min-width: 75%; padding-top: 0;justify-content: space-around;">
                    ...
                    <div class="item">
                        <div id="loginForm" class="d-flex direction-column">
                            ...
                            <input type="password" id="confirm_password" name="confirm_password" placeholder="Confirmar senha" class="input-form" style="border: solid 1px #e50914 !important;" required />
                        </div>
                    </div>
                    <div class="item">
                        <div id="loginForm" class="d-flex direction-column">
                            <input type="number" id="number" name="number" placeholder="Telefone" class="input-form" style="border: solid 1px #e50914 !important;"/>
                            <input type="file" id="img" name="img" class="input-form" style="border: solid 1px #e50914 !important;"/>
                            <input type="text" id="cartao" name="cartao" placeholder="Cartão de Crédito" class="input-form email" style="margin-bottom: 30px; border: solid 1px #e50914 !important;" required/>
